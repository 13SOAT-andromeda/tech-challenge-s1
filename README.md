...
2.  **Crie um arquivo `.env` na raiz do projeto**:
    ...
    _Nota: As variáveis são carregadas em `internal/adapter/config/config.go`._
...
- **Desenho de Arquitetura Local**: [arquitetura-local-k8s-kind-challenge-s1-soat-13.drawio.png](./misc/arquitetura-local-k8s-kind-challenge-s1-soat-13.drawio.png)
