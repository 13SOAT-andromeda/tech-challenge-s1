-- Seed: seed_product_maintenance
-- Description: Populates initial data for Product and Maintenance tables.
-- Run manually after the first migration/deploy on a fresh environment.
...
-- Maintenances (Price in cents)
-- Valid categories: padrao, utilitario, comercial, premium
